...
export default function PublicPortfolioPage() {
  ...
  const heroGradientByRole: Record<string, string> = {
    developer: "from-primary/10 via-primary/5 to-background",
    tester: "from-emerald-500/10 via-emerald-500/5 to-background",
    ai_ml: "from-indigo-500/10 via-fuchsia-500/10 to-background",
    data_analyst: "from-amber-500/10 via-sky-500/10 to-background",
  };

  const badgeVariantByRole: Record<string, string> = {
    developer: "secondary",
    tester: "outline",
    ai_ml: "secondary",
    data_analyst: "secondary",
  };
